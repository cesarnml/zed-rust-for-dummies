---
title: 'Hour 13: Capstone — build the PR in miniature'
description: A global theme, per-window overrides, and a trait split in two. About 150 lines, no GPUI.
sidebar:
  order: 14
---

Everything in the previous twelve hours exists to make this hour possible.
...
You have now built the architecture. [Hour 14](/crash/14-reading-the-diff/) opens
the real one and reads it line by line — the same shape, with GPUI in the way.
